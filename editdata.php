...
<!-------------------------------FORM EDIT--------------------------------------------------------------------------------------->
							<fieldset>
								<input type="text"/ placeholder="NIP" style="text-align:center">
								<input type="text" placeholder="Nama" style="text-align:center"/>
								...
								<input type="text" placeholder="Nomor Bis" style="text-align:center"/>
								
								<a href="admin.php" style="text-decoration:none"><input type="submit" value="Simpan" /></a>
							</fieldset>
<!------------------------------------------------------------------------------------------------------------------------->
						</div>
					</div>
