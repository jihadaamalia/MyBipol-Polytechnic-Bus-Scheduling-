					...
					<div class="formholder">aaa
						<div class="randompad">
							<fieldset>
								...
								<input type="password"/>
								<br>
								<a href="admin.php" style="text-decoration:none"><input type="submit" value="Login as Admin" /></a>
								<br>
								<a href="sesi.php" style="text-decoration:none"><input type="submit" value="Login as Driver"/></a>
							</fieldset>
						</div>
					</div>
					<!--
