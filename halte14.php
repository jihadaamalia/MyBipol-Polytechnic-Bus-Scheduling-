	...
	<header>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
				<center>
					<div class="halteholder">
						<div class="randompad">
<!------------------ BUTTON HALTE GERBATAMA A ------------------------------------------------------------------------>
							<fieldset>
							<br>
								<form method="post" action="">
                                    <input type="submit" class="button" name="gerbatamaA" value="GERBATAMA A"/>
								</form>
                                <br>
                                
                                <?php
                                    include('updatewaktu.php');
                                ?>
