            ...
            <div class="component">
                ...
                <table>
                    <thead>
                        <tr>
                            <th>BIS</th>
                            <th><?php echo $_SESSION['jdlhalte'] ?></th>
                        </tr>
                    </thead>
                    
                    <?php
                        $halte=$_SESSION['jdlhalte'];
                        $jadwal = mysql_query("SELECT no_bis, tiba FROM jadwal WHERE nama_halte='$halte'");
                ...
                <font color="white">
                <h3>Keterangan</h3>
                A = Arah meninggalkan Politeknik Negeri Jakarta
                <br>
                B = Arah menuju Politeknik Negeri Jakarta
                <br><br>
                </font>
